...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002177610937"))
OWNER_ID = int(os.environ.get("OWNER_ID", "5908553001"))
PORT = os.environ.get("PORT", "8080")
DB_URI = os.environ.get("DB_URI", "postgres://emzqisqp:cbKWoSPa1aAa77CFBxvOI9prHR_irlBP@rain.db.elephantsql.com/emzqisqp")
